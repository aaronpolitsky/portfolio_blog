...
From late 2017 through early 2020 I worked with Pacific Point, Inc. as a freelance data viz consultant, focusing on Tableau projects. My primary client was Hawai'i Data Collaborative. They had a number datasets of well-being metrics for a variety of domains like education, health, economic opportunity, among others. These were organized by geography, and for several types of geographic region (including school district, house district, etc.), as well as at the state level.

Over the course of the project I worked with them to develop and refine their ideas through prototyping and iteration, and of course implementation and production. This was mostly interactive Tableau dashboard work, but in some cases, I wrote some data-wrangling R scripts to get the data into an alternate shape so as to coerce Tableau into doing what we intended.
